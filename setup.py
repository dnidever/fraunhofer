...
setup(name='Fraunhofer',
      ...
      install_requires=['numpy','astropy(>=4.0)','scipy','dlnpyutils(>=1.0.3)','doppler @ git+https://github.com/dnidever/doppler@1.1.0#egg=doppler',
      ...
      dependency_links=['http://github.com/dnidever/doppler/tarball/1.1.0#egg=doppler','http://github.com/andycasey/AnniesLasso/tarball/master#egg=the-cannon'],
